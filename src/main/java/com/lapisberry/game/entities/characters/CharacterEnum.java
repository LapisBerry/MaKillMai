...
public enum CharacterEnum {
    ...
    /**
     * Phase 1: every character is a {@link GenericCharacter} placeholder so
     * the game loop can run end-to-end. Phase 2 will return concrete
     * subclasses that implement each character's ability.
     */
    public BaseCharacter createCharacter() {
        return new GenericCharacter(getDisplayName());
    }
}
